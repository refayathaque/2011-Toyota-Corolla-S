...
function isOneOfInputObjectType(namedType) {
    ...
    isOneOfType =
        graphql.isInputObjectType(namedType) &&
            (namedType.isOneOf ||
...
class ClientSideBaseVisitor extends BaseVisitor {
    ...
    _includeFragments(fragments, nodeKind) {
        if (fragments && fragments.length > 0) {
            ...
            if (this.config.documentMode === exports.DocumentMode.documentNodeImportFragments) {
                return '';
            }
    ...
    ${this._includeFragments(fragments, node.kind)}`);
        ...
        if (this.config.documentMode === exports.DocumentMode.string) {
            return '`' + doc + '`';
        }
